...
define('_MI_EGUIDE_MARKER_DEF', '0,<span class="label label-default">關閉中</span>,50,<span class="label label label-success">報名中</span>,100,<span class="label label-warning">反應熱烈</span>,101,<span class="label label-danger">已額滿</span>');//0,[關閉中],50,[報名中],100,[反應熱烈],101,[已額滿]
