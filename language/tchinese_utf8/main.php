...
define('_MD_ORDER_NOTE1', '\'' . _MD_REQUIRE_MARK . '\' 為必填項目');//\''._MD_REQUIRE_MARK.'\'* 為必填項目
define('_MD_ORDER_NOTE2', '\'[ ]\' 會顯示在參加者一覽表。');
define('_MD_ORDER_SEND', '確認資料無誤後按此報名');
define('_MD_ORDER_CONF', '前往確認頁');//你去確認
...
define('_MD_CLOSEBEFORE_DESC', '(即活動多久後開始,如: 3days、2hour或50min)');//即活動多久後開始,如: 1小時、2小時或50分鐘
define('_MD_TIME_UNIT', 'days,hour,min');//天,小時,分鐘
...
define('_MD_DETAIL', '詳細');//參加者一覽表
define('_MD_RESERV_MSG_H', '傳送訊息給報名者');
define('_MD_ACTIVATE', '通過');//審核
...
define('_MD_RESERV_ITEM', '追加項目');//<br>追加項目：
